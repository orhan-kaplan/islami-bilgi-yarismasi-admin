...
class DashboardPreview extends StatelessWidget {
      ...
      builder: (context, constraints) {
        return SingleChildScrollView(
          child: ConstrainedBox(
            ...
            child: Center(child: _buildComebackCard()),
          ),
        );
      },
    );
  ...
  ///
  /// Uzun başlık/mesaj metni sabit 693px çerçeveyi aşabilir. `Spacer()`
  /// kaydırılabilir bir eksende çalışamadığından sabit boşlukla
  /// değiştirildi ve tüm içerik SingleChildScrollView ile sarıldı.
  ...
  Widget _buildPlaceholderBlocks() {
    return Padding(
      padding: const EdgeInsets.all(16),
      child: Column(children: _buildGreyPlaceholders(4)),
    );
  }
